...
/**
 Base class for all _titanium views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the _titanium view hierarchy (such as wrapped iOS UIViews) was touched.
