...
/**
 Base class for all ThinkingOfU views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ThinkingOfU view hierarchy (such as wrapped iOS UIViews) was touched.
