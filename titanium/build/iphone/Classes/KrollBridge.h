...
@interface ThinkingOfUObject : KrollCoverageObject {
#else
@interface ThinkingOfUObject : KrollObject {
#endif
@private
...
extern NSString * ThinkingOfU$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ThinkingOfUObject *_thinkingofu;
    KrollObject* console;
	BOOL shutdown;
