...
@interface _titaniumObject : KrollCoverageObject {
#else
@interface _titaniumObject : KrollObject {
#endif
@private
...
extern NSString * _titanium$ModuleRequireFormat;
